  ...
  return (
    <div className="grid md:grid-cols-2 gap-8 max-w-6xl">
      ...
      <div className="space-y-4">
         <div className="bg-[#20242E] p-6 rounded-2xl border border-dashed border-white/[0.1] min-h-[300px] flex flex-col items-center justify-center text-center relative">
            {isUploading ? (
               ...
               <div className="text-slate-500">
                  <ImagePlus className="w-12 h-12 mx-auto mb-4 text-[#00D4C8]" />
         ...
         {images.length > 0 && (
            <div className="grid grid-cols-3 gap-3">
               {images.map((url, i) => (
                  <div key={i} className="relative group rounded-lg overflow-hidden border border-white/[0.06] bg-[#20242E] aspect-square flex items-center justify-center">
      ...
      <div className="space-y-6">
         <div className="bg-[#20242E] p-6 border border-white/[0.06] rounded-2xl shadow-sm space-y-6">
            
            <div className="grid grid-cols-2 gap-4">
               <div className="flex flex-col gap-2">
                  <Label className="text-xs text-slate-400 uppercase tracking-wide">Modèle IA</Label>
                  <select
                     className="w-full rounded-lg border border-white/[0.08] bg-[#141720] px-3 py-3 text-sm text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-[#00D4C8]/40 focus:border-[#00D4C8]/50 transition-colors cursor-pointer"
                     value={provider}
            ...
            <div className="space-y-2">
               ...
               <Textarea 
                  ...
                  className="min-h-[120px] bg-[#141720] border-white/[0.08] text-white placeholder:text-slate-600 focus:border-[#00D4C8]/50"
                  value={details}
            ...
            <div className="border border-white/[0.06] rounded-xl overflow-hidden">
               ...
               {showPromptOptions && (
                  <div className="p-4 bg-[#141720] border-t border-white/[0.06]">
                     <Textarea 
                        placeholder="Laissez vide pour utiliser le prompt natif."
                        className="min-h-[150px] text-xs font-mono bg-[#1A1D23] border-white/[0.08] text-slate-300 placeholder:text-slate-600 focus:border-[#00D4C8]/50"
                        value={customPrompt}
            ...
            <Button 
               ...
               className="w-full bg-[#00D4C8] hover:bg-[#00A89E] text-[#1A1D23] font-bold py-6 text-base shadow-md rounded-xl"
            >
               {isGenerating ? (
